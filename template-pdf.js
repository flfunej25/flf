// =================================================
// FILE: template-pdf.js (Versi dengan Font Times New Roman)
...
export function generateBuktiLolosPDF(peserta, jsPDF, autoTable) {
    ...
    doc.text('flfchapterunej@gmail.com | @flf.unej', doc.internal.pageSize.getWidth() / 2, 40, { align: 'center' });
    ...
    doc.autoTable({
      ...
      styles: { 
        font: 'times', // <-- FONT TABEL DIUBAH DI SINI
        cellPadding: 1.5, 
        fontSize: 12 
      },
      columnStyles: { 
